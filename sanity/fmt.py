...
ascii_map = [
    ...
    {'ansi_num': '&#131;', 'ansi_hex': u'ƒ', 'ascii_replace': 'f'},
    {'ansi_num': '&#132;', 'ansi_hex': u'„'},
    {'ansi_num': '&#133;', 'ansi_hex': u'…', 'ascii_replace': '...'},
    {'ansi_num': '&#134;', 'ansi_hex': u'†'},
    {'ansi_num': '&#135;', 'ansi_hex': u'‡'},
    ...
    {'ansi_num': '&#137;', 'ansi_hex': u'‰'},
    {'ansi_num': '&#138;', 'ansi_hex': u'Š', 'ascii_replace': 'S'},
    {'ansi_num': '&#139;', 'ansi_hex': u'‹', 'ascii_replace': '<'},
    {'ansi_num': '&#140;', 'ansi_hex': u'Œ'},
    {'ansi_num': '&#141;', 'ansi_hex': u'\x8D'},
    {'ansi_num': '&#142;', 'ansi_hex': u'Ž', 'ascii_replace': 'Z'},
    ...
    {'ansi_num': '&#158;', 'ansi_hex': u'ž', 'ascii_replace': 'z'},
    {'ansi_num': '&#159;', 'ansi_hex': u'Ÿ', 'ascii_replace': 'Y'},
    {'ansi_num': '&#160;', 'ansi_hex': (u'\xc2\xa0', u'\xA0'), 'html_entity': '&nbsp;', 'ascii_replace': ' '},
    ...
    {'ansi_num': '&#169;', 'ansi_hex': (u'©', u'\xc2\xa9', u'\xA9'), 'html_entity': '&copy;', 'ascii_replace': 'c'},
    {'ansi_num': '&#170;', 'ansi_hex': (u'ª', u'\xc2\xaa', u'\xAA'), 'html_entity': '&ordf;'},
    {'ansi_num': '&#171;', 'ansi_hex': (u'«', u'\xc2\xab', u'\xAB'), 'html_entity': '&laquo;', 'ascii_replace': '<<'},
    {'ansi_num': '&#172;', 'ansi_hex': (u'¬', u'\xc2\xac', u'\xAC'), 'html_entity': '&not;'},
    {'ansi_num': '&#173;', 'ansi_hex': (u'\xc2\xad', u'\xAD'), 'html_entity': '&shy;', 'ascii_replace': ''},
    {'ansi_num': '&#174;', 'ansi_hex': (u'®', u'\xc2\xae', u'\xAE'), 'html_entity': '&reg;', 'ascii_replace': 'R'},
    ...
    {'ansi_num': '&#187;', 'ansi_hex': (u'»', u'\xc2\xbb', u'\xBB'), 'html_entity': '&raquo;', 'ascii_replace': '>>'},
    {'ansi_num': '&#188;', 'ansi_hex': (u'¼', u'\xc2\xbc', u'\xBC'), 'html_entity': '&frac14;', 'ascii_replace': '1/4'},
    {'ansi_num': '&#189;', 'ansi_hex': (u'½', u'\xc2\xbd', u'\xBD'), 'html_entity': '&frac12;', 'ascii_replace': '1/2'},
    {'ansi_num': '&#190;', 'ansi_hex': (u'¾', u'\xc2\xbe', u'\xBE'), 'html_entity': '&frac34;', 'ascii_replace': '3/4'},
    {'ansi_num': '&#191;', 'ansi_hex': (u'¿', u'\xc2\xbf', u'\xBF'), 'html_entity': '&iquest;'},
    {'ansi_num': '&#192;', 'ansi_hex': (u'À', u'\xc3\x80', u'\xC0'), 'html_entity': '&Agrave;', 'ascii_replace': 'A'},
    {'ansi_num': '&#193;', 'ansi_hex': (u'Á', u'\xc3\x81', u'\xC1'), 'html_entity': '&Aacute;', 'ascii_replace': 'A'},
    {'ansi_num': '&#194;', 'ansi_hex': (u'Â', u'\xc3\x82', u'\xC2'), 'html_entity': '&Acirc;', 'ascii_replace': 'A'},
    {'ansi_num': '&#195;', 'ansi_hex': (u'Ã', u'\xc3\x83', u'\xC3'), 'html_entity': '&Atilde;', 'ascii_replace': 'A'},
    {'ansi_num': '&#196;', 'ansi_hex': (u'Ä', u'\xc3\x84', u'\xC4'), 'html_entity': '&Auml;', 'ascii_replace': 'A'},
    {'ansi_num': '&#197;', 'ansi_hex': (u'Å', u'\xc3\x85', u'\xC5'), 'html_entity': '&Aring;', 'ascii_replace': 'A'},
    {'ansi_num': '&#198;', 'ansi_hex': (u'Æ', u'\xc3\x86', u'\xC6'), 'html_entity': '&AElig;', 'ascii_replace': 'A'},
    {'ansi_num': '&#199;', 'ansi_hex': (u'Ç', u'\xc3\x87', u'\xC7'), 'html_entity': '&Ccedil;', 'ascii_replace': 'C'},
    {'ansi_num': '&#200;', 'ansi_hex': (u'È', u'\xc3\x88', u'\xC8'), 'html_entity': '&Egrave;', 'ascii_replace': 'E'},
    {'ansi_num': '&#201;', 'ansi_hex': (u'É', u'\xc3\x89', u'\xC9'), 'html_entity': '&Eacute;', 'ascii_replace': 'E'},
    {'ansi_num': '&#202;', 'ansi_hex': (u'Ê', u'\xc3\x8a', u'\xCA'), 'html_entity': '&Ecirc;', 'ascii_replace': 'E'},
    {'ansi_num': '&#203;', 'ansi_hex': (u'Ë', u'\xc3\x8b', u'\xCB'), 'html_entity': '&Euml;', 'ascii_replace': 'E'},
    {'ansi_num': '&#204;', 'ansi_hex': (u'Ì', u'\xc3\x8c', u'\xCC'), 'html_entity': '&Igrave;', 'ascii_replace': 'I'},
    {'ansi_num': '&#205;', 'ansi_hex': (u'Í', u'\xc3\x8d', u'\xCD'), 'html_entity': '&Iacute;', 'ascii_replace': 'I'},
    {'ansi_num': '&#206;', 'ansi_hex': (u'Î', u'\xc3\x8e', u'\xCE'), 'html_entity': '&Icirc;', 'ascii_replace': 'I'},
    {'ansi_num': '&#207;', 'ansi_hex': (u'Ï', u'\xc3\x8f', u'\xCF'), 'html_entity': '&Iuml;', 'ascii_replace': 'I'},
    {'ansi_num': '&#208;', 'ansi_hex': (u'Ð', u'\xc3\x90', u'\xD0'), 'html_entity': '&ETH;', 'ascii_replace': 'D'},
    {'ansi_num': '&#209;', 'ansi_hex': (u'Ñ', u'\xc3\x91', u'\xD1'), 'html_entity': '&Ntilde;', 'ascii_replace': 'N'},
    {'ansi_num': '&#210;', 'ansi_hex': (u'Ò', u'\xc3\x92', u'\xD2'), 'html_entity': '&Ograve;', 'ascii_replace': 'O'},
    {'ansi_num': '&#211;', 'ansi_hex': (u'Ó', u'\xc3\x93', u'\xD3'), 'html_entity': '&Oacute;', 'ascii_replace': 'O'},
    {'ansi_num': '&#212;', 'ansi_hex': (u'Ô', u'\xc3\x94', u'\xD4'), 'html_entity': '&Ocirc;', 'ascii_replace': 'O'},
    {'ansi_num': '&#213;', 'ansi_hex': (u'Õ', u'\xc3\x95', u'\xD5'), 'html_entity': '&Otilde;', 'ascii_replace': 'O'},
    {'ansi_num': '&#214;', 'ansi_hex': (u'Ö', u'\xc3\x96', u'\xD6'), 'html_entity': '&Ouml;', 'ascii_replace': 'O'},
    {'ansi_num': '&#215;', 'ansi_hex': (u'×', u'\xc3\x97', u'\xD7'), 'html_entity': '&times;', 'ascii_replace': '*'},
    {'ansi_num': '&#216;', 'ansi_hex': (u'Ø', u'\xc3\x98', u'\xD8'), 'html_entity': '&Oslash;', 'ascii_replace': 'O'},
    {'ansi_num': '&#217;', 'ansi_hex': (u'Ù', u'\xc3\x99', u'\xD9'), 'html_entity': '&Ugrave;', 'ascii_replace': 'U'},
    {'ansi_num': '&#218;', 'ansi_hex': (u'Ú', u'\xc3\x9a', u'\xDA'), 'html_entity': '&Uacute;', 'ascii_replace': 'U'},
    {'ansi_num': '&#219;', 'ansi_hex': (u'Û', u'\xc3\x9b', u'\xDB'), 'html_entity': '&Ucirc;', 'ascii_replace': 'U'},
    {'ansi_num': '&#220;', 'ansi_hex': (u'Ü', u'\xc3\x9c', u'\xDC'), 'html_entity': '&Uuml;', 'ascii_replace': 'U'},
    {'ansi_num': '&#221;', 'ansi_hex': (u'Ý', u'\xc3\x9d', u'\xDD'), 'html_entity': '&Yacute;', 'ascii_replace': 'Y'},
    {'ansi_num': '&#222;', 'ansi_hex': (u'Þ', u'\xc3\x9e', u'\xDE'), 'html_entity': '&THORN;'},
    {'ansi_num': '&#223;', 'ansi_hex': (u'ß', u'\xc3\x9f', u'\xDF'), 'html_entity': '&szlig;', 'ascii_replace': 'B'},
    {'ansi_num': ('&#224;', '&#24;'), 'ansi_hex': (u'à', u'\xc3\xa0', u'\xE0'), 'html_entity': '&agrave;', 'ascii_replace': 'a'},
    {'ansi_num': ('&#225;', '&#25;'), 'ansi_hex': (u'á', u'\xc3\xa1', u'\xE1'), 'html_entity': '&aacute;', 'ascii_replace': 'a'},
    {'ansi_num': '&#226;', 'ansi_hex': (u'â', u'\xc3\xa2', u'\xE2'), 'html_entity': '&acirc;', 'ascii_replace': 'a'},
    {'ansi_num': '&#227;', 'ansi_hex': (u'ã', u'\xc3\xa3', u'\xE3'), 'html_entity': '&atilde;', 'ascii_replace': 'a'},
    {'ansi_num': '&#228;', 'ansi_hex': (u'ä', u'\xc3\xa4', u'\xE4'), 'html_entity': '&auml;', 'ascii_replace': 'a'},
    {'ansi_num': '&#229;', 'ansi_hex': (u'å', u'\xc3\xa5', u'\xE5'), 'html_entity': '&aring;', 'ascii_replace': 'a'},
    {'ansi_num': '&#230;', 'ansi_hex': (u'æ', u'\xc3\xa6', u'\xE6'), 'html_entity': '&aelig;'},
    {'ansi_num': '&#231;', 'ansi_hex': (u'ç', u'\xc3\xa7', u'\xE7'), 'html_entity': '&ccedil;', 'ascii_replace': 'c'},
    {'ansi_num': '&#232;', 'ansi_hex': (u'è', u'\xc3\xa8', u'\xE8'), 'html_entity': '&egrave;', 'ascii_replace': 'e'},
    {'ansi_num': '&#233;', 'ansi_hex': (u'é', u'\xc3\xa9', u'\xE9'), 'html_entity': '&eacute;', 'ascii_replace': 'e'},
    {'ansi_num': '&#234;', 'ansi_hex': (u'ê', u'\xc3\xaa', u'\xEA'), 'html_entity': '&ecirc;', 'ascii_replace': 'e'},
    {'ansi_num': '&#235;', 'ansi_hex': (u'ë', u'\xc3\xab', u'\xEB'), 'html_entity': '&euml;', 'ascii_replace': 'e'},
    {'ansi_num': '&#236;', 'ansi_hex': (u'ì', u'\xc3\xac', u'\xEC'), 'html_entity': '&igrave;', 'ascii_replace': 'i'},
    {'ansi_num': '&#237;', 'ansi_hex': (u'í', u'\xc3\xad', u'\xED'), 'html_entity': '&iacute;', 'ascii_replace': 'i'},
    {'ansi_num': '&#238;', 'ansi_hex': (u'î', u'\xc3\xae', u'\xEE'), 'html_entity': '&icirc;', 'ascii_replace': 'i'},
    {'ansi_num': '&#239;', 'ansi_hex': (u'ï', u'\xc3\xaf', u'\xEF'), 'html_entity': '&iuml;', 'ascii_replace': 'i'},
    {'ansi_num': '&#240;', 'ansi_hex': (u'ð', u'\xc3\xb0', u'\xF0'), 'html_entity': '&eth;', 'ascii_replace': 'o'},
    {'ansi_num': '&#241;', 'ansi_hex': (u'ñ', u'\xc3\xb1', u'\xF1'), 'html_entity': '&ntilde;', 'ascii_replace': 'n'},
    {'ansi_num': '&#242;', 'ansi_hex': (u'ò', u'\xc3\xb2', u'\xF2'), 'html_entity': '&ograve;', 'ascii_replace': 'o'},
    {'ansi_num': '&#243;', 'ansi_hex': (u'ó', u'\xc3\xb3', u'\xF3'), 'html_entity': '&oacute;', 'ascii_replace': 'o'},
    {'ansi_num': '&#244;', 'ansi_hex': (u'ô', u'\xc3\xb4', u'\xF4', u'\xf4'), 'html_entity': '&ocirc;', 'ascii_replace': 'o'},
    {'ansi_num': '&#245;', 'ansi_hex': (u'õ', u'\xc3\xb5', u'\xF5'), 'html_entity': '&otilde;', 'ascii_replace': 'o'},
    {'ansi_num': '&#246;', 'ansi_hex': (u'ö', u'\xc3\xb6', u'\xF6'), 'html_entity': '&ouml;', 'ascii_replace': 'o'},
    {'ansi_num': '&#247;', 'ansi_hex': (u'÷', u'\xc3\xb7', u'\xF7'), 'html_entity': '&divide;', 'ascii_replace': '/'},
    {'ansi_num': '&#248;', 'ansi_hex': (u'ø', u'\xc3\xb8', u'\xF8'), 'html_entity': '&oslash;', 'ascii_replace': 'o'},
    {'ansi_num': '&#249;', 'ansi_hex': (u'ù', u'\xc3\xb9', u'\xF9'), 'html_entity': '&ugrave;', 'ascii_replace': 'u'},
    {'ansi_num': '&#250;', 'ansi_hex': (u'ú', u'\xc3\xba', u'\xFA'), 'html_entity': '&uacute;', 'ascii_replace': 'u'},
    {'ansi_num': '&#251;', 'ansi_hex': (u'û', u'\xc3\xbb', u'\xFB'), 'html_entity': '&ucirc;', 'ascii_replace': 'u'},
    {'ansi_num': '&#252;', 'ansi_hex': (u'ü', u'\xc3\xbc', u'\xFC'), 'html_entity': '&uuml;', 'ascii_replace': 'u'},
    {'ansi_num': '&#253;', 'ansi_hex': (u'ý', u'\xc3\xbd', u'\xFD'), 'html_entity': '&yacute;', 'ascii_replace': 'y'},
    {'ansi_num': '&#254;', 'ansi_hex': (u'þ', u'\xc3\xbe', u'\xFE'), 'html_entity': '&thorn;'},
    {'ansi_num': '&#255;', 'ansi_hex': (u'ÿ', u'\xc3\xbf', u'\xFF'), 'html_entity': '&yuml;', 'ascii_replace': 'y'},
    {'ansi_num': '&#256;', 'ansi_hex': u'Ā', 'ascii_replace': 'A'},
    {'ansi_num': '&#257;', 'ansi_hex': u'ā', 'ascii_replace': 'a'},
    {'ansi_num': '&#258;', 'ansi_hex': u'Ă', 'ascii_replace': 'A'},
    {'ansi_num': '&#259;', 'ansi_hex': u'ă', 'ascii_replace': 'a'},
    {'ansi_num': '&#260;', 'ansi_hex': u'Ą', 'ascii_replace': 'A'},
    {'ansi_num': '&#261;', 'ansi_hex': u'ą', 'ascii_replace': 'a'},
    {'ansi_num': '&#262;', 'ansi_hex': u'Ć', 'ascii_replace': 'C'},
    {'ansi_num': '&#263;', 'ansi_hex': u'ć', 'ascii_replace': 'c'},
    {'ansi_num': '&#264;', 'ansi_hex': u'Ĉ', 'ascii_replace': 'C'},
    {'ansi_num': '&#265;', 'ansi_hex': u'ĉ', 'ascii_replace': 'c'},
    {'ansi_num': '&#266;', 'ansi_hex': u'Ċ', 'ascii_replace': 'C'},
    {'ansi_num': '&#267;', 'ansi_hex': u'ċ', 'ascii_replace': 'c'},
    {'ansi_num': '&#268;', 'ansi_hex': u'Č', 'ascii_replace': 'C'},
    {'ansi_num': '&#269;', 'ansi_hex': u'č', 'ascii_replace': 'c'},
    {'ansi_num': '&#270;', 'ansi_hex': u'Ď', 'ascii_replace': 'D'},
    {'ansi_num': '&#271;', 'ansi_hex': u'ď', 'ascii_replace': 'd'},
    {'ansi_num': '&#272;', 'ansi_hex': u'Đ', 'ascii_replace': 'D'},
    {'ansi_num': '&#273;', 'ansi_hex': u'đ', 'ascii_replace': 'd'},
    {'ansi_num': '&#274;', 'ansi_hex': u'Ē', 'ascii_replace': 'E'},
    {'ansi_num': '&#275;', 'ansi_hex': u'ē', 'ascii_replace': 'e'},
    {'ansi_num': '&#276;', 'ansi_hex': u'Ĕ', 'ascii_replace': 'E'},
    {'ansi_num': '&#277;', 'ansi_hex': u'ĕ', 'ascii_replace': 'e'},
    {'ansi_num': '&#278;', 'ansi_hex': u'Ė', 'ascii_replace': 'E'},
    {'ansi_num': '&#279;', 'ansi_hex': u'ė', 'ascii_replace': 'e'},
    {'ansi_num': '&#280;', 'ansi_hex': u'Ę', 'ascii_replace': 'E'},
    {'ansi_num': '&#281;', 'ansi_hex': u'ę', 'ascii_replace': 'e'},
    {'ansi_num': '&#282;', 'ansi_hex': u'Ě', 'ascii_replace': 'E'},
    {'ansi_num': '&#283;', 'ansi_hex': u'ě', 'ascii_replace': 'e'},
    {'ansi_num': '&#284;', 'ansi_hex': u'Ĝ', 'ascii_replace': 'G'},
    {'ansi_num': '&#285;', 'ansi_hex': u'ĝ', 'ascii_replace': 'g'},
    {'ansi_num': '&#286;', 'ansi_hex': u'Ğ', 'ascii_replace': 'G'},
    {'ansi_num': '&#287;', 'ansi_hex': u'ğ', 'ascii_replace': 'g'},
    {'ansi_num': '&#288;', 'ansi_hex': u'Ġ', 'ascii_replace': 'G'},
    {'ansi_num': '&#289;', 'ansi_hex': u'ġ', 'ascii_replace': 'g'},
    {'ansi_num': '&#290;', 'ansi_hex': u'Ģ', 'ascii_replace': 'G'},
    {'ansi_num': '&#291;', 'ansi_hex': u'ģ', 'ascii_replace': 'g'},
    {'ansi_num': '&#292;', 'ansi_hex': u'Ĥ', 'ascii_replace': 'H'},
    {'ansi_num': '&#293;', 'ansi_hex': u'ĥ', 'ascii_replace': 'h'},
    {'ansi_num': '&#294;', 'ansi_hex': u'Ħ', 'ascii_replace': 'H'},
    {'ansi_num': '&#295;', 'ansi_hex': u'ħ', 'ascii_replace': 'h'},
    {'ansi_num': '&#296;', 'ansi_hex': u'Ĩ', 'ascii_replace': 'I'},
    {'ansi_num': '&#297;', 'ansi_hex': u'ĩ', 'ascii_replace': 'i'},
    {'ansi_num': '&#298;', 'ansi_hex': u'Ī', 'ascii_replace': 'I'},
    {'ansi_num': '&#299;', 'ansi_hex': u'ī', 'ascii_replace': 'i'},
    {'ansi_num': '&#300;', 'ansi_hex': u'Ĭ', 'ascii_replace': 'I'},
    {'ansi_num': '&#301;', 'ansi_hex': u'ĭ', 'ascii_replace': 'i'},
    {'ansi_num': '&#302;', 'ansi_hex': u'Į', 'ascii_replace': 'I'},
    {'ansi_num': '&#303;', 'ansi_hex': u'į', 'ascii_replace': 'i'},
    {'ansi_num': '&#304;', 'ansi_hex': u'İ', 'ascii_replace': 'I'},
    {'ansi_num': '&#305;', 'ansi_hex': u'ı', 'ascii_replace': 'i'},
    {'ansi_num': '&#306;', 'ansi_hex': u'Ĳ', 'ascii_replace': 'I'},
    {'ansi_num': '&#307;', 'ansi_hex': u'ĳ', 'ascii_replace': 'i'},
    {'ansi_num': '&#308;', 'ansi_hex': u'Ĵ', 'ascii_replace': 'J'},
    {'ansi_num': '&#309;', 'ansi_hex': u'ĵ', 'ascii_replace': 'j'},
    {'ansi_num': '&#310;', 'ansi_hex': u'Ķ', 'ascii_replace': 'K'},
    {'ansi_num': '&#311;', 'ansi_hex': u'ķ', 'ascii_replace': 'k'},
    {'ansi_num': '&#312;', 'ansi_hex': u'ĸ', 'ascii_replace': 'k'},
    {'ansi_num': '&#313;', 'ansi_hex': u'Ĺ', 'ascii_replace': 'L'},
    {'ansi_num': '&#314;', 'ansi_hex': u'ĺ', 'ascii_replace': 'l'},
    {'ansi_num': '&#315;', 'ansi_hex': u'Ļ', 'ascii_replace': 'L'},
    {'ansi_num': '&#316;', 'ansi_hex': u'ļ', 'ascii_replace': 'l'},
    {'ansi_num': '&#317;', 'ansi_hex': u'Ľ', 'ascii_replace': 'L'},
    {'ansi_num': '&#318;', 'ansi_hex': u'ľ', 'ascii_replace': 'l'},
    {'ansi_num': '&#319;', 'ansi_hex': u'Ŀ', 'ascii_replace': 'L'},
    {'ansi_num': '&#320;', 'ansi_hex': u'ŀ', 'ascii_replace': 'l'},
    {'ansi_num': '&#321;', 'ansi_hex': u'Ł', 'ascii_replace': 'L'},
    {'ansi_num': '&#322;', 'ansi_hex': u'ł'},
    {'ansi_num': '&#323;', 'ansi_hex': u'Ń', 'ascii_replace': 'N'},
    {'ansi_num': '&#324;', 'ansi_hex': u'ń', 'ascii_replace': 'n'},
    {'ansi_num': '&#325;', 'ansi_hex': u'Ņ', 'ascii_replace': 'N'},
    {'ansi_num': '&#326;', 'ansi_hex': u'ņ', 'ascii_replace': 'n'},
    {'ansi_num': '&#327;', 'ansi_hex': u'Ň', 'ascii_replace': 'N'},
    {'ansi_num': '&#328;', 'ansi_hex': u'ň', 'ascii_replace': 'n'},
    {'ansi_num': '&#329;', 'ansi_hex': u'ŉ', 'ascii_replace': 'n'},
    {'ansi_num': '&#330;', 'ansi_hex': u'Ŋ', 'ascii_replace': 'N'},
    {'ansi_num': '&#331;', 'ansi_hex': u'ŋ', 'ascii_replace': 'n'},
    {'ansi_num': '&#332;', 'ansi_hex': u'Ō', 'ascii_replace': 'O'},
    {'ansi_num': '&#333;', 'ansi_hex': u'ō', 'ascii_replace': 'o'},
    {'ansi_num': '&#334;', 'ansi_hex': u'Ŏ', 'ascii_replace': 'O'},
    {'ansi_num': '&#335;', 'ansi_hex': u'ŏ', 'ascii_replace': 'o'},
    {'ansi_num': '&#336;', 'ansi_hex': u'Ő', 'ascii_replace': 'O'},
    {'ansi_num': '&#337;', 'ansi_hex': u'ő', 'ascii_replace': 'o'},
    {'ansi_num': '&#338;', 'ansi_hex': (u'Œ', u'\xc5\x92', u'\x8C'), 'html_entity': '&OElig;'},
    {'ansi_num': '&#339;', 'ansi_hex': (u'œ', u'\xc5\x93', u'\x9C'), 'html_entity': '&oelig;'},
    {'ansi_num': '&#340;', 'ansi_hex': u'Ŕ', 'ascii_replace': 'R'},
    {'ansi_num': '&#341;', 'ansi_hex': u'ŕ', 'ascii_replace': 'r'},
    {'ansi_num': '&#342;', 'ansi_hex': u'Ŗ', 'ascii_replace': 'R'},
    {'ansi_num': '&#343;', 'ansi_hex': u'ŗ', 'ascii_replace': 'r'},
    {'ansi_num': '&#344;', 'ansi_hex': u'Ř', 'ascii_replace': 'R'},
    {'ansi_num': '&#345;', 'ansi_hex': u'ř', 'ascii_replace': 'r'},
    {'ansi_num': '&#346;', 'ansi_hex': u'Ś', 'ascii_replace': 'S'},
    {'ansi_num': '&#347;', 'ansi_hex': u'ś', 'ascii_replace': 's'},
    {'ansi_num': '&#348;', 'ansi_hex': u'Ŝ', 'ascii_replace': 'S'},
    {'ansi_num': '&#349;', 'ansi_hex': u'ŝ', 'ascii_replace': 's'},
    {'ansi_num': '&#350;', 'ansi_hex': u'Ş', 'ascii_replace': 'S'},
    {'ansi_num': '&#351;', 'ansi_hex': u'ş', 'ascii_replace': 's'},
    {'ansi_num': '&#352;', 'ansi_hex': (u'Š', u'\xc5\xa0', u'\x8A'), 'html_entity': '&Scaron;', 'ascii_replace': 'S'},
    {'ansi_num': '&#353;', 'ansi_hex': (u'š', u'\xc5\xa1', u'\x9A'), 'html_entity': '&scaron;', 'ascii_replace': 's'},
    {'ansi_num': '&#354;', 'ansi_hex': u'Ţ', 'ascii_replace': 'T'},
    {'ansi_num': '&#355;', 'ansi_hex': u'ţ', 'ascii_replace': 't'},
    {'ansi_num': '&#356;', 'ansi_hex': u'Ť', 'ascii_replace': 'T'},
    {'ansi_num': '&#357;', 'ansi_hex': u'ť', 'ascii_replace': 't'},
    {'ansi_num': '&#358;', 'ansi_hex': u'Ŧ', 'ascii_replace': 'T'},
    {'ansi_num': '&#359;', 'ansi_hex': u'ŧ', 'ascii_replace': 't'},
    {'ansi_num': '&#360;', 'ansi_hex': u'Ũ', 'ascii_replace': 'U'},
    {'ansi_num': '&#361;', 'ansi_hex': u'ũ', 'ascii_replace': 'u'},
    {'ansi_num': '&#362;', 'ansi_hex': u'Ū', 'ascii_replace': 'U'},
    {'ansi_num': '&#363;', 'ansi_hex': u'ū', 'ascii_replace': 'u'},
    {'ansi_num': '&#364;', 'ansi_hex': u'Ŭ', 'ascii_replace': 'U'},
    {'ansi_num': '&#365;', 'ansi_hex': u'ŭ', 'ascii_replace': 'u'},
    {'ansi_num': '&#366;', 'ansi_hex': u'Ů', 'ascii_replace': 'U'},
    {'ansi_num': '&#367;', 'ansi_hex': u'ů', 'ascii_replace': 'u'},
    {'ansi_num': '&#368;', 'ansi_hex': u'Ű', 'ascii_replace': 'U'},
    {'ansi_num': '&#369;', 'ansi_hex': u'ű', 'ascii_replace': 'u'},
    {'ansi_num': '&#370;', 'ansi_hex': u'Ų', 'ascii_replace': 'U'},
    {'ansi_num': '&#371;', 'ansi_hex': u'ų', 'ascii_replace': 'u'},
    {'ansi_num': '&#372;', 'ansi_hex': u'Ŵ', 'ascii_replace': 'W'},
    {'ansi_num': '&#373;', 'ansi_hex': u'ŵ', 'ascii_replace': 'w'},
    {'ansi_num': '&#374;', 'ansi_hex': u'Ŷ', 'ascii_replace': 'Y'},
    {'ansi_num': '&#375;', 'ansi_hex': u'ŷ', 'ascii_replace': 'y'},
    {'ansi_num': '&#376;', 'ansi_hex': (u'Ÿ', u'\xc5\xb8', u'\x9F'), 'html_entity': '&Yuml;', 'ascii_replace': 'Y'},
    {'ansi_num': '&#377;', 'ansi_hex': u'Ź', 'ascii_replace': 'Z'},
    {'ansi_num': '&#378;', 'ansi_hex': u'ź', 'ascii_replace': 'z'},
    {'ansi_num': '&#379;', 'ansi_hex': u'Ż', 'ascii_replace': 'Z'},
    {'ansi_num': '&#380;', 'ansi_hex': u'ż', 'ascii_replace': 'z'},
    {'ansi_num': '&#381;', 'ansi_hex': u'\x8E'},
    {'ansi_num': '&#382;', 'ansi_hex': u'\x9E'},
    {'ansi_num': '&#383;', 'ansi_hex': u'ſ'},
    {'ansi_num': '&#384;', 'ansi_hex': u'ƀ', 'ascii_replace': 'b'},
    {'ansi_num': '&#385;', 'ansi_hex': u'Ɓ', 'ascii_replace': 'B'},
    {'ansi_num': '&#386;', 'ansi_hex': u'Ƃ', 'ascii_replace': 'b'},
    {'ansi_num': '&#387;', 'ansi_hex': u'ƃ', 'ascii_replace': 'b'},
    {'ansi_num': '&#388;', 'ansi_hex': u'Ƅ', 'ascii_replace': 'b'},
    {'ansi_num': '&#389;', 'ansi_hex': u'ƅ', 'ascii_replace': 'b'},
    {'ansi_num': '&#390;', 'ansi_hex': u'Ɔ', 'ascii_replace': 'C'},
    {'ansi_num': '&#391;', 'ansi_hex': u'Ƈ', 'ascii_replace': 'C'},
    {'ansi_num': '&#392;', 'ansi_hex': u'ƈ', 'ascii_replace': 'c'},
    {'ansi_num': '&#393;', 'ansi_hex': u'Ɖ', 'ascii_replace': 'D'},
    {'ansi_num': '&#394;', 'ansi_hex': u'Ɗ', 'ascii_replace': 'D'},
    ...
    {'ansi_num': '&#401;', 'ansi_hex': u'Ƒ', 'ascii_replace': 'F'},
    {'ansi_num': '&#402;', 'ansi_hex': (u'ƒ', u'\xc6\x92', u'\x83'), 'html_entity': '&fnof;'},
    {'ansi_num': '&#403;', 'ansi_hex': u'Ɠ', 'ascii_replace': 'G'},
    ...
    {'ansi_num': '&#459;', 'ansi_hex': u'ǋ'},
    {'ansi_num': '&#460;', 'ansi_hex': u'ǌ'},
    {'ansi_num': '&#461;', 'ansi_hex': u'Ǎ', 'ascii_replace': 'A'},
    {'ansi_num': '&#462;', 'ansi_hex': u'ǎ', 'ascii_replace': 'a'},
    {'ansi_num': '&#463;', 'ansi_hex': u'Ǐ', 'ascii_replace': 'I'},
    {'ansi_num': '&#464;', 'ansi_hex': u'ǐ', 'ascii_replace': 'i'},
    {'ansi_num': '&#465;', 'ansi_hex': u'Ǒ', 'ascii_replace': 'O'},
    {'ansi_num': '&#466;', 'ansi_hex': u'ǒ', 'ascii_replace': 'o'},
    {'ansi_num': '&#467;', 'ansi_hex': u'Ǔ', 'ascii_replace': 'U'},
    {'ansi_num': '&#468;', 'ansi_hex': u'ǔ', 'ascii_replace': 'u'},
    {'ansi_num': '&#469;', 'ansi_hex': u'Ǖ', 'ascii_replace': 'U'},
    {'ansi_num': '&#470;', 'ansi_hex': u'ǖ', 'ascii_replace': 'u'},
    {'ansi_num': '&#471;', 'ansi_hex': u'Ǘ', 'ascii_replace': 'U'},
    {'ansi_num': '&#472;', 'ansi_hex': u'ǘ', 'ascii_replace': 'u'},
    {'ansi_num': '&#473;', 'ansi_hex': u'Ǚ', 'ascii_replace': 'U'},
    {'ansi_num': '&#474;', 'ansi_hex': u'ǚ', 'ascii_replace': 'u'},
    {'ansi_num': '&#475;', 'ansi_hex': u'Ǜ', 'ascii_replace': 'U'},
    {'ansi_num': '&#476;', 'ansi_hex': u'ǜ', 'ascii_replace': 'u'},
    {'ansi_num': '&#477;', 'ansi_hex': u'ǝ', 'ascii_replace': 'e'},
    {'ansi_num': '&#478;', 'ansi_hex': u'Ǟ', 'ascii_replace': 'A'},
    {'ansi_num': '&#479;', 'ansi_hex': u'ǟ', 'ascii_replace': 'a'},
    {'ansi_num': '&#480;', 'ansi_hex': u'Ǡ', 'ascii_replace': 'A'},
    {'ansi_num': '&#481;', 'ansi_hex': u'ǡ', 'ascii_replace': 'a'},
    {'ansi_num': '&#482;', 'ansi_hex': u'Ǣ'},
    {'ansi_num': '&#483;', 'ansi_hex': u'ǣ'},
    {'ansi_num': '&#484;', 'ansi_hex': u'Ǥ', 'ascii_replace': 'G'},
    {'ansi_num': '&#485;', 'ansi_hex': u'ǥ', 'ascii_replace': 'g'},
    {'ansi_num': '&#486;', 'ansi_hex': u'Ǧ', 'ascii_replace': 'G'},
    {'ansi_num': '&#487;', 'ansi_hex': u'ǧ', 'ascii_replace': 'g'},
    {'ansi_num': '&#488;', 'ansi_hex': u'Ǩ', 'ascii_replace': 'K'},
    {'ansi_num': '&#489;', 'ansi_hex': u'ǩ', 'ascii_replace': 'k'},
    {'ansi_num': '&#490;', 'ansi_hex': u'Ǫ', 'ascii_replace': 'Q'},
    {'ansi_num': '&#491;', 'ansi_hex': u'ǫ', 'ascii_replace': 'q'},
    {'ansi_num': '&#492;', 'ansi_hex': u'Ǭ', 'ascii_replace': 'Q'},
    {'ansi_num': '&#493;', 'ansi_hex': u'ǭ', 'ascii_replace': 'q'},
    ...
    {'ansi_num': '&#498;', 'ansi_hex': u'ǲ'},
    {'ansi_num': '&#499;', 'ansi_hex': u'ǳ'},
    {'ansi_num': '&#500;', 'ansi_hex': u'Ǵ', 'ascii_replace': 'G'},
    {'ansi_num': '&#501;', 'ansi_hex': u'ǵ', 'ascii_replace': 'g'},
    {'ansi_num': '&#502;', 'ansi_hex': u'Ƕ'},
    {'ansi_num': '&#503;', 'ansi_hex': u'Ƿ'},
    {'ansi_num': '&#504;', 'ansi_hex': u'Ǹ', 'ascii_replace': 'N'},
    {'ansi_num': '&#505;', 'ansi_hex': u'ǹ', 'ascii_replace': 'n'},
    {'ansi_num': '&#506;', 'ansi_hex': u'Ǻ', 'ascii_replace': 'A'},
    {'ansi_num': '&#507;', 'ansi_hex': u'ǻ', 'ascii_replace': 'a'},
    {'ansi_num': '&#508;', 'ansi_hex': u'Ǽ'},
    {'ansi_num': '&#509;', 'ansi_hex': u'ǽ'},
    {'ansi_num': '&#510;', 'ansi_hex': u'Ǿ'},
    {'ansi_num': '&#511;', 'ansi_hex': u'ǿ'},
    {'ansi_num': '&#512;', 'ansi_hex': u'Ȁ', 'ascii_replace': 'A'},
    {'ansi_num': '&#513;', 'ansi_hex': u'ȁ', 'ascii_replace': 'a'},
    {'ansi_num': '&#514;', 'ansi_hex': u'Ȃ', 'ascii_replace': 'A'},
    {'ansi_num': '&#515;', 'ansi_hex': u'ȃ', 'ascii_replace': 'a'},
    {'ansi_num': '&#516;', 'ansi_hex': u'Ȅ', 'ascii_replace': 'E'},
    {'ansi_num': '&#517;', 'ansi_hex': u'ȅ', 'ascii_replace': 'e'},
    {'ansi_num': '&#518;', 'ansi_hex': u'Ȇ', 'ascii_replace': 'E'},
    {'ansi_num': '&#519;', 'ansi_hex': u'ȇ', 'ascii_replace': 'e'},
    {'ansi_num': '&#520;', 'ansi_hex': u'Ȉ', 'ascii_replace': 'I'},
    {'ansi_num': '&#521;', 'ansi_hex': u'ȉ', 'ascii_replace': 'i'},
    {'ansi_num': '&#522;', 'ansi_hex': u'Ȋ', 'ascii_replace': 'I'},
    {'ansi_num': '&#523;', 'ansi_hex': u'ȋ', 'ascii_replace': 'i'},
    {'ansi_num': '&#524;', 'ansi_hex': u'Ȍ', 'ascii_replace': 'O'},
    {'ansi_num': '&#525;', 'ansi_hex': u'ȍ', 'ascii_replace': 'o'},
    {'ansi_num': '&#526;', 'ansi_hex': u'Ȏ', 'ascii_replace': 'O'},
    {'ansi_num': '&#527;', 'ansi_hex': u'ȏ', 'ascii_replace': 'o'},
    {'ansi_num': '&#528;', 'ansi_hex': u'Ȑ', 'ascii_replace': 'R'},
    {'ansi_num': '&#529;', 'ansi_hex': u'ȑ', 'ascii_replace': 'r'},
    {'ansi_num': '&#530;', 'ansi_hex': u'Ȓ', 'ascii_replace': 'R'},
    {'ansi_num': '&#531;', 'ansi_hex': u'ȓ', 'ascii_replace': 'r'},
    {'ansi_num': '&#532;', 'ansi_hex': u'Ȕ', 'ascii_replace': 'U'},
    {'ansi_num': '&#533;', 'ansi_hex': u'ȕ', 'ascii_replace': 'u'},
    {'ansi_num': '&#534;', 'ansi_hex': u'Ȗ', 'ascii_replace': 'U'},
    {'ansi_num': '&#535;', 'ansi_hex': u'ȗ', 'ascii_replace': 'u'},
    {'ansi_num': '&#536;', 'ansi_hex': u'Ș', 'ascii_replace': 'S'},
    {'ansi_num': '&#537;', 'ansi_hex': u'ș', 'ascii_replace': 's'},
    {'ansi_num': '&#538;', 'ansi_hex': u'Ț', 'ascii_replace': 'T'},
    {'ansi_num': '&#539;', 'ansi_hex': u'ț', 'ascii_replace': 't'},
    {'ansi_num': '&#540;', 'ansi_hex': u'Ȝ'},
    {'ansi_num': '&#541;', 'ansi_hex': u'ȝ'},
    {'ansi_num': '&#542;', 'ansi_hex': u'Ȟ', 'ascii_replace': 'H'},
    {'ansi_num': '&#543;', 'ansi_hex': u'ȟ', 'ascii_replace': 'h'},
    {'ansi_num': '&#544;', 'ansi_hex': u'Ƞ'},
    {'ansi_num': '&#545;', 'ansi_hex': u'ȡ'},
    {'ansi_num': '&#546;', 'ansi_hex': u'Ȣ'},
    {'ansi_num': '&#547;', 'ansi_hex': u'ȣ'},
    {'ansi_num': '&#548;', 'ansi_hex': u'Ȥ', 'ascii_replace': 'Z'},
    {'ansi_num': '&#549;', 'ansi_hex': u'ȥ', 'ascii_replace': 'z'},
    {'ansi_num': '&#550;', 'ansi_hex': u'Ȧ', 'ascii_replace': 'A'},
    {'ansi_num': '&#551;', 'ansi_hex': u'ȧ', 'ascii_replace': 'a'},
    {'ansi_num': '&#552;', 'ansi_hex': u'Ȩ', 'ascii_replace': 'E'},
    {'ansi_num': '&#553;', 'ansi_hex': u'ȩ', 'ascii_replace': 'e'},
    {'ansi_num': '&#554;', 'ansi_hex': u'Ȫ', 'ascii_replace': 'O'},
    {'ansi_num': '&#555;', 'ansi_hex': u'ȫ', 'ascii_replace': 'o'},
    {'ansi_num': '&#556;', 'ansi_hex': u'Ȭ', 'ascii_replace': 'O'},
    {'ansi_num': '&#557;', 'ansi_hex': u'ȭ', 'ascii_replace': 'o'},
    {'ansi_num': '&#558;', 'ansi_hex': u'Ȯ', 'ascii_replace': 'O'},
    {'ansi_num': '&#559;', 'ansi_hex': u'ȯ', 'ascii_replace': 'o'},
    {'ansi_num': '&#560;', 'ansi_hex': u'Ȱ', 'ascii_replace': 'O'},
    {'ansi_num': '&#561;', 'ansi_hex': u'ȱ', 'ascii_replace': 'o'},
    {'ansi_num': '&#562;', 'ansi_hex': u'Ȳ', 'ascii_replace': 'Y'},
    {'ansi_num': '&#563;', 'ansi_hex': u'ȳ', 'ascii_replace': 'y'},
    ...
    {'ansi_num': '&#730;', 'ansi_hex': u'˚'},
    {'ansi_num': '&#731;', 'ansi_hex': u'˛'},
    {'ansi_num': '&#732;', 'ansi_hex': (u'˜', u'\xcb\x9c', u'\x98'), 'html_entity': '&tilde;', 'ascii_replace': '~'},
    {'ansi_num': '&#733;', 'ansi_hex': u'˝'},
    {'ansi_num': '&#734;', 'ansi_hex': u'˞'},
    {'ansi_num': '&#735;', 'ansi_hex': u'˟'},
    ...
    {'ansi_num': '&#900;', 'ansi_hex': u'΄'},
    {'ansi_num': '&#901;', 'ansi_hex': u'΅'},
    {'ansi_num': '&#902;', 'ansi_hex': u'Ά', 'ascii_replace': 'A'},
    {'ansi_num': '&#903;', 'ansi_hex': u'·'},
    {'ansi_num': '&#904;', 'ansi_hex': u'Έ', 'ascii_replace': 'E'},
    {'ansi_num': '&#905;', 'ansi_hex': u'Ή', 'ascii_replace': 'H'},
    {'ansi_num': '&#906;', 'ansi_hex': u'Ί', 'ascii_replace': 'I'},
    {'ansi_num': '&#907;', 'ansi_hex': u'΋'},
    {'ansi_num': '&#908;', 'ansi_hex': u'Ό', 'ascii_replace': 'I'},
    {'ansi_num': '&#909;', 'ansi_hex': u'΍'},
    {'ansi_num': '&#910;', 'ansi_hex': u'Ύ', 'ascii_replace': 'Y'},
    {'ansi_num': '&#911;', 'ansi_hex': u'Ώ'},
    {'ansi_num': '&#912;', 'ansi_hex': u'ΐ', 'ascii_replace': 'i'},
    {'ansi_num': "&#913;", 'ansi_hex': (u'Α', u'\xce\x91'), 'html_entity': "&Alpha;", 'ascii_replace': 'A'},
    {'ansi_num': "&#914;", 'ansi_hex': (u'Β', u'\xce\x92'), 'html_entity': "&Beta;", 'ascii_replace': 'B'},
    {'ansi_num': "&#915;", 'ansi_hex': (u'Γ', u'\xce\x93'), 'html_entity': "&Gamma;"},
    {'ansi_num': "&#916;", 'ansi_hex': (u'Δ', u'\xe2\x88\x86'), 'html_entity': "&Delta;"},
    {'ansi_num': "&#917;", 'ansi_hex': (u'Ε', u'\xce\x95'), 'html_entity': "&Epsilon;", 'ascii_replace': 'E'},
    {'ansi_num': "&#918;", 'ansi_hex': (u'Ζ', u'\xce\x96'), 'html_entity': "&Zeta;", 'ascii_replace': 'Z'},
    {'ansi_num': "&#919;", 'ansi_hex': (u'Η', u'\xce\x97'), 'html_entity': "&Eta;", 'ascii_replace': 'H'},
    {'ansi_num': "&#920;", 'ansi_hex': (u'Θ', u'\xce\x98'), 'html_entity': "&Theta;"},
    {'ansi_num': "&#921;", 'ansi_hex': (u'Ι', u'\xce\x99'), 'html_entity': "&Iota;", 'ascii_replace': 'I'},
    {'ansi_num': "&#922;", 'ansi_hex': (u'Κ', u'\xce\x9a'), 'html_entity': "&Kappa;", 'ascii_replace': 'K'},
    {'ansi_num': "&#923;", 'ansi_hex': (u'Λ', u'\xce\x9b'), 'html_entity': "&Lambda;"},
    {'ansi_num': "&#924;", 'ansi_hex': (u'Μ', u'\xce\x9c'), 'html_entity': "&Mu;", 'ascii_replace': 'M'},
    {'ansi_num': "&#925;", 'ansi_hex': (u'Ν', u'\xce\x9d'), 'html_entity': "&Nu;", 'ascii_replace': 'N'},
    {'ansi_num': "&#926;", 'ansi_hex': (u'Ξ', u'\xce\x9e'), 'html_entity': "&Xi;"},
    {'ansi_num': "&#927;", 'ansi_hex': (u'Ο', u'\xce\x9f'), 'html_entity': "&Omicron;", 'ascii_replace': 'O'},
    {'ansi_num': "&#928;", 'ansi_hex': (u'Π', u'\xce\xa0'), 'html_entity': "&Pi;"},
    {'ansi_num': "&#929;", 'ansi_hex': (u'Ρ', u'\xce\xa1'), 'html_entity': "&Rho;", 'ascii_replace': 'P'},
    {'ansi_num': '&#930;', 'ansi_hex': u'΢'},
    {'ansi_num': "&#931;", 'ansi_hex': (u'Σ', u'\xce\xa3'), 'html_entity': "&Sigma;"},
    {'ansi_num': "&#932;", 'ansi_hex': (u'Τ', u'\xce\xa4'), 'html_entity': "&Tau;", 'ascii_replace': 'T'},
    {'ansi_num': "&#933;", 'ansi_hex': (u'Υ', u'\xce\xa5'), 'html_entity': "&Upsilon;", 'ascii_replace': 'Y'},
    {'ansi_num': "&#934;", 'ansi_hex': (u'Φ', u'\xce\xa6'), 'html_entity': "&Phi;"},
    {'ansi_num': "&#935;", 'ansi_hex': u'Χ', 'html_entity': "&Chi;", 'ascii_replace': 'X'},
    {'ansi_num': "&#936;", 'ansi_hex': u'Ψ', 'html_entity': "&Psi;"},
    {'ansi_num': "&#937;", 'ansi_hex': (u'Ω', u'\xe2\x84\xa6'), 'html_entity': "&Omega;"},
    {'ansi_num': '&#938;', 'ansi_hex': u'Ϊ', 'ascii_replace': 'I'},
    {'ansi_num': '&#939;', 'ansi_hex': u'Ϋ', 'ascii_replace': 'Y'},
    {'ansi_num': '&#940;', 'ansi_hex': u'ά'},
    {'ansi_num': '&#941;', 'ansi_hex': u'έ'},
    {'ansi_num': '&#942;', 'ansi_hex': u'ή', 'ascii_replace': 'n'},
    {'ansi_num': '&#943;', 'ansi_hex': u'ί', 'ascii_replace': 'i'},
    {'ansi_num': '&#944;', 'ansi_hex': u'ΰ', 'ascii_replace': 'v'},
    ...
    {'ansi_num': '&#970;', 'ansi_hex': u'ϊ', 'ascii_replace': 'i'},
    {'ansi_num': '&#971;', 'ansi_hex': u'ϋ', 'ascii_replace': 'v'},
    {'ansi_num': '&#972;', 'ansi_hex': u'ό', 'ascii_replace': 'o'},
    {'ansi_num': '&#973;', 'ansi_hex': u'ύ', 'ascii_replace': 'v'},
    {'ansi_num': '&#974;', 'ansi_hex': u'ώ', 'ascii_replace': 'w'},
    ...
    {'ansi_num': '&#983;', 'ansi_hex': u'ϗ'},
    {'ansi_num': '&#984;', 'ansi_hex': u'Ϙ', 'ascii_replace': 'Q'},
    {'ansi_num': '&#985;', 'ansi_hex': u'ϙ', 'ascii_replace': 'q'},
    {'ansi_num': '&#986;', 'ansi_hex': u'Ϛ'},
    {'ansi_num': '&#987;', 'ansi_hex': u'ϛ'},
    {'ansi_num': '&#988;', 'ansi_hex': u'Ϝ', 'ascii_replace': 'F'},
    {'ansi_num': '&#989;', 'ansi_hex': u'ϝ', 'ascii_replace': 'f'},
    ...
    {'ansi_num': "&#8211;", 'ansi_hex': (u'–', u'\xe2\x80\x93', u'\x96'), 'html_entity': "&ndash;", 'ascii_replace': '-'},
    {'ansi_num': '&#8212;', 'ansi_hex': (u'—', u'\xe2\x80\x94', u'\x97'), 'html_entity': '&mdash;', 'ascii_replace': '--'},
    {'ansi_num': '&#8216;', 'ansi_hex': (u'‘', u'\xe2\x80\x98', u'\x91'), 'html_entity': '&lsquo;', 'ascii_replace': "'"},
    {'ansi_num': '&#8217;', 'ansi_hex': (u'’', u'\xe2\x80\x99', u'\x92'), 'html_entity': '&rsquo;', 'ascii_replace': "'"},
    {'ansi_num': '&#8218;', 'ansi_hex': (u'‚', u'\xe2\x80\x9a', u'\x82'), 'html_entity': '&sbquo;'},
    {'ansi_num': '&#8220;', 'ansi_hex': (u'“', u'\xe2\x80\x9c', u'\x93'), 'html_entity': '&ldquo;', 'ascii_replace': '"'},
    {'ansi_num': '&#8221;', 'ansi_hex': (u'”', u'\xe2\x80\x9d', u'\x94'), 'html_entity': '&rdquo;', 'ascii_replace': '"'},
    ...
    {'ansi_num': '&#8230;', 'ansi_hex': (u'…', u'\xe2\x80\xa6', u'\x85'), 'html_entity': '&hellip;', 'ascii_replace': '...'},
    {'ansi_num': '&#8240;', 'ansi_hex': (u'‰', u'\xe2\x80\xb0', u'\x89'), 'html_entity': '&permil;'},
    {'ansi_num': "&#8242;", 'ansi_hex': (u'′', u'\xe2\x80\xb2'), 'html_entity': "&prime;", 'ascii_replace': "'"},
    {'ansi_num': "&#8243;", 'ansi_hex': (u'″', u'\xe2\x80\xb3'), 'html_entity': "&Prime;", 'ascii_replace': '"'},
    {'ansi_num': '&#8249;', 'ansi_hex': (u'‹', u'\xe2\x80\xb9', u'\x8B'), 'html_entity': '&lsaquo;', 'ascii_replace': '<'},
    {'ansi_num': '&#8250;', 'ansi_hex': (u'›', u'\xe2\x80\xba', u'\x9B'), 'html_entity': '&rsaquo;', 'ascii_replace': '>'},
    {'ansi_num': "&#8254;", 'ansi_hex': (u'‾', u'\xef\xa3\xa5'), 'html_entity': "&oline;", 'ascii_replace': ' '},
    {'ansi_num': "&#8260;", 'ansi_hex': (u'⁄', u'\xe2\x81\x84'), 'html_entity': "&frasl;", 'ascii_replace': '/'},
